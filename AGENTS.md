...
- **Quality gates:** 131/131 unit tests · 28/28 Playwright e2e (desktop Chromium + Pixel 7 + iPhone 8 + iPhone 17 Pro Max, incl. dialog-above-tab-bar & recovery/resume flows on every mobile profile) · Lighthouse 94–95 perf / 100 a11y / 100 BP / 100 SEO · CI auto-deploys `main` → Pages (title: typecheck + unit tests; typecheck of e2e not covered — e2e/ sits outside tsconfig include)
